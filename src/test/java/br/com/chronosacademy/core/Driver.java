...
public class Driver {
    ...
    private static void startChrome() {
        ...
        chromeOptions.setHeadless(headless);  //Headless é para o front ser chamado por debaixo dos panos

        driver = new ChromeDriver(chromeOptions);
        driver.manage().window().setSize(new Dimension(2200, 720)); //Alterar resolução de tela das imagens de evidencias
    }
    ...
    public static void visibilityOf(WebElement element) {
        wait.until(ExpectedConditions.visibilityOf(element)); // Espera o elemento ser visivel para poder fazer o que precisa

    }

    public static void invisibilityOf(WebElement element) {
        wait.until(ExpectedConditions.invisibilityOf(element)); // Espera o elemento estar invisivel para poder fazer o que precisa
    }
